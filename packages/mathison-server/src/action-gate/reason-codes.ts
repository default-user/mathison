...
export enum GovernanceReasonCode {
  ...
  // Genome failures
  GENOME_MISSING = 'GENOME_MISSING',
  GENOME_INVALID_SCHEMA = 'GENOME_INVALID_SCHEMA',
  GENOME_INVALID_SIGNATURE = 'GENOME_INVALID_SIGNATURE',
  GENOME_CAPABILITY_DENIED = 'GENOME_CAPABILITY_DENIED',
